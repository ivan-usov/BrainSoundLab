...
function [xdata, ydata, allx, ally, meanallx, meanally, stdrallx, stdrally] = SpikePT1_SB()
...
newname = strcat(userDir,'_AnalysisSpikesPT1.mat');
...
analysis.BFnumber= y;
figname = strcat(userDir,'_AnalysisSpikesPT1.fig');
