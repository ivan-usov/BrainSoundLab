...
function [xdata, ydata, allx, ally, meanallx, meanally, stdrallx, stdrally] = SpikeFMS_SB()
...
newname = strcat(userDir,'_AnalysisSpikesFMS60dB75up4-8kHz.mat');
...
analysis.BFnumber= y;
figname = strcat(userDir,'_AnalysisSpikesFMS60dB175up4-8kHz.fig');
