...
function [xdata, ydata, allx,ally,meanallx, meanally,stdrallx,stdrally] = RTIvsBF_TRB()
...
dprime=3;
%RSI parameters
RSIlevel=3; %RSIlevel of 1=40dB, RSIlevel of 2=60dBM RSIlevel of 3=80dB
RSIdirection=2; %RSIdirection of 1=down, RSIdirection of 2=up
...
%         end
    ...
    function [x, x_label, y, y_label] = extractData(block1, block2, sitesDepth)
        ...
        RSI = block2.custom.RSIrate{1};
        RSI = cellfun(@(x) x(RSIlevel,RSIdirection), RSI); 
