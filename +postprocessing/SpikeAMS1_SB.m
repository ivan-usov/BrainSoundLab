...
function [xdata, ydata, allx, ally, meanallx, meanally, stdrallx, stdrally] = SpikeAMS1_SB()
blockType1 = 'experiment.ToneFine';
blockType2 = 'experiment.AMS';
...
%         end
    ...
    function [x, x_label, y, y_label] = extractData(block1, block2)
        ...
        TRF = block2.custom.TRFnum{1};
        TRF = cellfun(@(x) x(2,1), TRF); % 1-3: 5,10,20 kHz, 1-12: -200 to +200 ms
...
newname = strcat(userDir,'_AnalysisSpikes1AMS10kHz-200ms.mat');
...
analysis.BFnumber= y;
figname = strcat(userDir,'_AnalysisSpikes1AMS10kHz-200ms.fig');
