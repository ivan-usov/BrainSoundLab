...
function [xdata, ydata, allx, ally, meanallx, meanally, stdrallx, stdrally] = SpikenFMS1_SB()
...
%         end
    ...
    function [x, x_label, y, y_label] = extractData(block1, block2)
        ...
        TRF = cellfun(@(x) x(2,7), TRF); % 1-3: 40,60,80 dB; 1-12: -90 oct/s to +90 oct/s
...
newname = strcat(userDir,'_AnalysisSpikes1nFMS60dB15up.mat');
...
analysis.BFnumber= y;
figname = strcat(userDir,'_AnalysisSpikes1nFMS60dB15up.fig');
