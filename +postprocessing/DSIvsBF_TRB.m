...
function [xdata, ydata, allx,ally,meanallx, meanally,stdrallx,stdrally] = DSIvsBF_TRB()
...
DSIspeed=5; %DSIspeed of 6=90oct/s, DSIspeed of 5=75oct/s etc
...
% caluclate mean and stdr of allx and ally data
numbern=length(ally);
meanallx=mean(allx);
