...
function [xdata, ydata, allx, ally, meanallx, meanally, stdrallx, stdrally] = SpikeAMS_SB()
...
%         end
    ...
    function [x, x_label, y, y_label] = extractData(block1, block2, sitesDepth)
        ...
        TRF = cellfun(@(x) x(2,6), TRF); % 1-3: 5,10,20 kHz; 1-12: -200 to +200 ms
...
newname = strcat(userDir,'_AnalysisSpikesAMS.mat');
...
analysis.BFnumber= y;
figname = strcat(userDir,'_AnalysisSpikesAMS.fig');
