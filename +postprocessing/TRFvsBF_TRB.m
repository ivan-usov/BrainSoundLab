...
function [xdata, ydata, allx,ally,meanallx, meanally,stdrallx,stdrally] = TRFvsBF_TRB()
...
dprime=3;
%TRF parameters
TRFlevel=2; %TRFlevel of 1=40dB, TRFlevel of 2=60dBM TRFlevel of 3=80dB
TRFspeed=12; %TRFspeed of 2=-75oct/s, TRFspeed of 11=75oct/s etc
...
%         end
    ...
    function [x, x_label, y, y_label] = extractData(block1, block2, sitesDepth)
        ...
        TRF = cellfun(@(x) x(TRFlevel,TRFspeed), TRF);
